//
//  CafeJoinAlertViewController.swift
//  Qnnect
//
...
final class CafeJoinErrorAlertViewController: BaseViewController {
    ...
    static func create(with message: String) -> CafeJoinErrorAlertViewController {
        let vc = CafeJoinErrorAlertViewController()
        vc.message = message
        return vc
    }
